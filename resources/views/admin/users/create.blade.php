                    ...
                    <div class="mb-3  col-sm-7">
                        ...
                        <div class="input-group input-group-merge">
                            ...
                            <input type="text" class="form-control" id="basic-icon-default-fullname"
                                placeholder="Masukan Nama Lengkap" aria-label="John Doe"
                    ...
                    <div class="mb-3 col-sm-7">
                        ...
                        <div class="input-group input-group-merge">
                            <span id="basic-icon-default-fullname2" class="input-group-text"><i
                                    class="bx bx-user"></i></span>
                            <input type="text" class="form-control" id="basic-icon-default-fullname"
                                placeholder="Password" aria-label="Password" aria-describedby="basic-icon-default-fullname2"
                                name="password" />
                            @error('password')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group input-group-merge">
                            ...
                            <select name="city_id" id="city"
                                style="border-radius: 0 0.375rem 0.375rem 0;  border-color:#d9dee3;" class="col-sm-3">
                    ...
                    <div class="mb-3 col-sm-7">
                        ...
                        <div class="input-group input-group-merge">
                            ...
                            <input type="text" id="basic-icon-default-email" class="form-control"
                                placeholder="example@example.com" aria-label="email"
                    ...
                    <div class="mb-3 col-sm-7">
                        ...
                        <div class="input-group input-group-merge">
                            ...
                            <input type="text" id="basic-icon-default-phone" class="form-control phone-mask"
                                placeholder="+62812xxxx" aria-label="07xxxxxxxx"
